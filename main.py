...
class FrontEnd:
    ...
    def menu_initialisation(self):
        self.master.geometry('900x700+250+10')
...
#"""**********************************Header********************************************"""
        ...
        self.logo = PhotoImage(file='photo.png').subsample(5, 6)

        title_font = ('Arial', 20, 'bold')  # Define a font for the title
        label_font = ('Arial', 12)  # Define a font for the labels

        title_style = ttk.Style()
        title_style.configure("Title.TLabel", font=title_font, foreground="black")  # Configure the style for the title

        label_style = ttk.Style()
        label_style.configure("Label.TLabel", font=label_font, foreground="black")  # Configure the style for the labels

        ttk.Label(self.frame_header, image=self.logo).grid(
            row=0, column=0, rowspan=2)
        ttk.Label(self.frame_header, text='Welcome to the Image Editor App!', style="Title.TLabel").grid(
            row=0, column=1, columnspan=1)
        ttk.Label(self.frame_header, text='Upload, edit and save your images Easily!', style="Label.TLabel").grid(
...
#"""**********************************Main Menu********************************************"""
        ...
        self.frame_menu.config(relief=RIDGE, padding=(90, 30))
